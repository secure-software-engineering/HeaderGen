import numpy as np
import re
from pandas._typing import ArrayLike as ArrayLike, Scalar as Scalar
...
def compare_or_regex_search(a: ArrayLike, b: Union[Scalar, Pattern], regex: bool, mask: np.ndarray) -> Union[ArrayLike, bool]: ...
def replace_regex(values: ArrayLike, rx: re.Pattern, value, mask: Union[np.ndarray, None]): ...
