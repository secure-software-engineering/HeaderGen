...
def cut(x, bins, right: bool = ..., labels: Any | None = ..., retbins: bool = ..., precision: int = ..., include_lowest: bool = ..., duplicates: str = ..., ordered: bool = ...): ...
def qcut(x, q, labels: Any | None = ..., retbins: bool = ..., precision: int = ..., duplicates: str = ...): ...
