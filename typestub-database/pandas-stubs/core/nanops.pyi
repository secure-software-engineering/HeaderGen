...
from pandas._libs import NaT as NaT, NaTType as NaTType, Timedelta as Timedelta, iNaT as iNaT, lib as lib
...
class bottleneck_switch:
    name: Any
    kwargs: Any
    def __init__(self, name: Any | None = ..., **kwargs) -> None: ...
...
def nanmedian(values, *, axis: Any | None = ..., skipna: bool = ..., mask: Any | None = ...): ...
def get_empty_reduction_result(shape: tuple[int, ...], axis: int, dtype: Union[np.dtype, type[np.floating]], fill_value: Any) -> np.ndarray: ...
def nanstd(values, *, axis: Any | None = ..., skipna: bool = ..., ddof: int = ..., mask: Any | None = ...): ...
def nanvar(values, *, axis: Any | None = ..., skipna: bool = ..., ddof: int = ..., mask: Any | None = ...): ...
...
def nancorr(a: np.ndarray, b: np.ndarray, *, method: str = ..., min_periods: Union[int, None] = ...): ...
def get_corr_func(method): ...
def nancov(a: np.ndarray, b: np.ndarray, *, min_periods: Union[int, None] = ..., ddof: Union[int, None] = ...): ...
def make_nancomp(op): ...
