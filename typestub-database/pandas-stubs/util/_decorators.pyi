...
def deprecate_nonkeyword_arguments(version: Union[str, None], allowed_args: Union[list[str], None] = ..., stacklevel: int = ...) -> Callable[[F], F]: ...
...
def indent(text: Union[str, None], indents: int = ...) -> str: ...
