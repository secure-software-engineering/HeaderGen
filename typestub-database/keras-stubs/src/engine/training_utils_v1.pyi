...
class Aggregator(metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    def aggregate(
        self, batch_outs, batch_start: Any | None = ..., batch_end: Any | None = ...
    ): ...
    @abc.abstractmethod
    def finalize(self): ...
...
class MetricsAggregator(Aggregator):
    def __init__(
        self, use_steps, num_samples: Any | None = ..., steps: Any | None = ...
    ) -> None: ...
    results: Any
...
class ConcatAggregator(Aggregator):
    ...
    def aggregate(
        self, batch_element, batch_start: Any | None = ..., batch_end: Any | None = ...
    ) -> None: ...
    results: Any
    def finalize(self) -> None: ...
...
def check_num_samples(
    ins, batch_size: Any | None = ..., steps: Any | None = ..., steps_name: str = ...
): ...
...
def get_metric_function(
    metric, output_shape: Any | None = ..., loss_fn: Any | None = ...
): ...
...
def validate_dataset_input(
    x, y, sample_weight, validation_split: Any | None = ...
) -> None: ...
def validate_input_types(
    inp, orig_inp, allow_dict: bool = ..., field_name: str = ...
) -> None: ...
...
def prepare_loss_weights(
    training_endpoints, loss_weights: Any | None = ...
) -> None: ...
...
def infer_steps_for_dataset(
    model, dataset, steps, epochs: int = ..., steps_name: str = ...
): ...
