...
class StringLookup(index_lookup.IndexLookup):
    encoding: Any
    def __init__(self, max_tokens: Any | None = ..., num_oov_indices: int = ..., mask_token: Any | None = ..., oov_token: str = ..., vocabulary: Any | None = ..., idf_weights: Any | None = ..., encoding: Any | None = ..., invert: bool = ..., output_mode: str = ..., sparse: bool = ..., pad_to_max_tokens: bool = ..., **kwargs) -> None: ...
    def get_config(self): ...
