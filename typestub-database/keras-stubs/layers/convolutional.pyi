...
from keras.layers.pooling import AveragePooling1D as AveragePooling1D, AveragePooling2D as AveragePooling2D, AveragePooling3D as AveragePooling3D, MaxPooling1D as MaxPooling1D, MaxPooling2D as MaxPooling2D, MaxPooling3D as MaxPooling3D
...
class DepthwiseConv(Conv):
    ...
    depthwise_constraint: Any
    bias_initializer: Any
    def __init__(self, rank, kernel_size, strides: int = ..., padding: str = ..., depth_multiplier: int = ..., data_format: Any | None = ..., dilation_rate: int = ..., activation: Any | None = ..., use_bias: bool = ..., depthwise_initializer: str = ..., bias_initializer: str = ..., depthwise_regularizer: Any | None = ..., bias_regularizer: Any | None = ..., activity_regularizer: Any | None = ..., depthwise_constraint: Any | None = ..., bias_constraint: Any | None = ..., **kwargs) -> None: ...
    depthwise_kernel: Any
    bias: Any
    input_spec: Any
    built: bool
...
class DepthwiseConv1D(DepthwiseConv):
    def __init__(self, kernel_size, strides: int = ..., padding: str = ..., depth_multiplier: int = ..., data_format: Any | None = ..., dilation_rate: int = ..., activation: Any | None = ..., use_bias: bool = ..., depthwise_initializer: str = ..., bias_initializer: str = ..., depthwise_regularizer: Any | None = ..., bias_regularizer: Any | None = ..., activity_regularizer: Any | None = ..., depthwise_constraint: Any | None = ..., bias_constraint: Any | None = ..., **kwargs) -> None: ...
    def call(self, inputs): ...
    def compute_output_shape(self, input_shape): ...
