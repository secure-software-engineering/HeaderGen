...
def InceptionV3(include_top: bool = ..., weights: str = ..., input_tensor: Any | None = ..., input_shape: Any | None = ..., pooling: Any | None = ..., classes: int = ..., classifier_activation: str = ...): ...
def conv2d_bn(x, filters, num_row, num_col, padding: str = ..., strides=..., name: Any | None = ...): ...
