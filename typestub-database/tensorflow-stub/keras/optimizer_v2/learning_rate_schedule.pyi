...
class NoisyLinearCosineDecay(LearningRateSchedule):
    ...
    beta: Any
    name: Any
    def __init__(self, initial_learning_rate, decay_steps, initial_variance: float = ..., variance_decay: float = ..., num_periods: float = ..., alpha: float = ..., beta: float = ..., name: Any | None = ...) -> None: ...
    def __call__(self, step): ...
    def get_config(self): ...
