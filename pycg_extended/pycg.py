...
class CallGraphGenerator(object):
    ...
    def setUp(self):
        ...
        self.typestub_manager = TypeStubManager()
        self.cg = CallGraph()
        self.cs = CallSites()
        self.ca = {}
    ...
    def analyze(self):
        ...
        elif self.operation == utils.constants.CALL_SITE_OP:
            self.do_pass(
                CallSiteProcessor,
                False,
                self.import_manager,
    ...
    def output_call_sites(self, module_name=None):
        return self.cs.get_call_sites_lineno(module_name)
