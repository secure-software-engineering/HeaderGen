...
define([
    ...
    'nbextensions/headergen-extension/hg'
], function(
    requirejs,
    $,
    Jupyter,
    ...
    function set_input_visible(show) {
        ...
        if (show) $('div.text_cell_render.rendered_html').show('slow');
        else $('div.text_cell_render.rendered_html').hide('slow');
        ...
        $('#toggle_codecells').attr(
            'title', (show ? 'Hide' : 'Show') + ' HeaderGen Annotations');
    }
    ...
    var load_ipython_extension = function() {
        ...
        $(Jupyter.toolbar.add_buttons_group([
            Jupyter.keyboard_manager.actions.register({
                help   : 'Hide HeaderGen Annotations',
                icon   : 'fa-eye',
                handler: function() {
                    toggle();
